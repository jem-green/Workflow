...
{
	[Serializable]
	public class KeyedList<K, V> : IDictionary<K, V>, IList<KeyValuePair<K, V>>, IEnumerable
	{
      ...
      //  }
		...
		/// </summary>
		//public IEnumerator<KeyValuePair<K, V>> IEnumerable<KeyValuePair<K, V>>.GetEnumerator()
